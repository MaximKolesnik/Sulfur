...
namespace Sulfur
{
  ...
  public:
    ...
    void DrawBox2D(const Matrix4& transform, Real w = 1.0f, Real h = 1.0f, const Vector4& color = DEFAULT_COLOR);
    void DrawBox(const Matrix4& transform, Real w = 1.0f, Real h = 1.0f, Real d = 1.0f, const Vector4& color = DEFAULT_COLOR);
    void DrawSphere(const Vector3& center, Real radius = 0.5f, const Vector4& color = DEFAULT_COLOR);
    void DrawSphere(const Matrix4& transform, Real radius = 0.5f, const Vector4& color = DEFAULT_COLOR);
    void DrawSphereHorizon(const Vector3& center, Real radius, const Vector4& color = DEFAULT_COLOR);
    void DrawCone(const Vector3& tip, const Vector3& direction, const Vector3& right, const Vector3& up, Real height, Real angle, const Vector4& color = DEFAULT_COLOR);
