...
namespace Sulfur
{
  ...
  public:
    ...
    SF_FORCE_INLINE explicit SF_VEC_CALL Matrix3(const Quaternion &q)
    {
      Real s = q.LengthSq();
    ...
    SF_FORCE_INLINE explicit SF_VEC_CALL Matrix3(Real e00, Real e01, Real e02,
    ...
    SF_FORCE_INLINE explicit SF_VEC_CALL Matrix3(const Vector3 &v0, const Vector3 &v1,
      const Vector3 &v2)
    {
      m_rows[0] = v0;
      m_rows[1] = v1;
